        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            ...
            image: carPhotos[index] != "null"
                ? Image.memory(Base64Converter.decodeImage64(carPhotos[index]))
                    .image
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            carPhotos[index] =
                                await selectImageFromGallery(index);
                            if (carPhotos[index] != "null") {
                              Navigator.pop(context);
                              setState(() {
                                EditDriverAuthScreen.editDriver.carPhotos =
                                    carPhotos;
                              });
                            } else {
                        ...
                        GestureDetector(
                          onTap: () async {
                            carPhotos[index] =
                                await selectImageFromCamera(index);
                            if (carPhotos[index] != "null") {
                              Navigator.pop(context);
                              setState(() {
                                EditDriverAuthScreen.editDriver.carPhotos =

...
class MakeReview extends StatelessWidget {
  ...
  var driverId;
  var tripId;
  MakeReview(var name, var age, var city, var start_time, var finish_time,
      var tripId, var customerId, var driverId) {
    this.name = name;
    this.age = age;
    this.city = city;
              ...
              children: [
                Container(
                  ...
                  padding: EdgeInsets.only(
                      bottom: phoneHeight * 0.03, top: phoneHeight * 0.03),
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                padding:
                                    EdgeInsets.only(left: phoneWidth * 0.02),
                                child: const Text(
                                  "Finish 12-01-2022",
                                  style: TextStyle(color: Colors.white),
                                ),
